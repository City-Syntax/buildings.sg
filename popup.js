const contentData = {
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>Land Use ID</td>
                    <td>Name</td>
                    <td>Unique identifier assigned to each land parcel in the Master Plan</td>
                    <td>Text</td>
                    <td>URA</td>
                </tr>
                <tr>
                    <td>Land Use GPR</td>
                    <td>GPR</td>
                    <td>Maximum permissible gross plot ratio specified for the parcel</td>
                    <td>Number</td>
                    <td>URA</td>
                </tr>
                <tr>
                    <td>Land Use Description</td>
                    <td>LU_DESC</td>
                    <td>Official land use designation under the URA Master Plan 2019 (e.g., Residential, Commercial, Park)</td>
                    <td>Text</td>
                    <td>URA</td>
                </tr>
            </tbody>
    ...
    about: `
        ...
        <p>The <a href="#" class="link">Buildings.sg</a> is an interactive platform developed by <a href="https://www.citysyntax.io/" class="link">City Syntax Lab</a> at the <a href="https://nus.edu.sg/" class="link">
        National University of Singapore (NUS)</a>. It visualizes and analyzes the carbon emissions of buildings across Singapore, covering both operational and embodied carbon footprints. By integrating geographic data 
        with building performance insights, the platform empowers policymakers, industry professionals, and the public to identify opportunities for carbon reduction. This platform supports Singapore's 
        <a href="https://www.greenplan.gov.sg/" class="link">Green Plan 2030</a> by promoting energy-efficient designs, sustainable materials, and low-carbon construction practices, driving progress toward 
        a more sustainable built environment.</p>
        <p>Buildings.sg leverages urban building energy modeling and machine learning to assess, predict and visualize energy use and carbon emissions for buildings across Singapore.</p>
        ...
        <h2>Buildings.city UBEM Platform</h2>
        <p>Buildings.city is <strong>a lightweight toolkit</strong> developed through <a href="#" class="link">Buildings.sg</a> to help cities quickly build interactive <strong>Urban Building Energy Modeling (UBEM) </strong>platforms using their own building data. 
        Through a simple configuration system and GeoJSON datasets, the package enables cities and researchers to visualize urban buildings, explore energy-related information, and communicate city-scale building data through an interactive map interface.</p>
        <p>In addition to data visualization, the platform can support basic workflows for operational carbon and embodied carbon analysis by connecting user-provided datasets or simulation results. Buildings.city was initially 
        developed as part of a research effort to lower the technical barrier for deploying urban energy platforms and <strong>can be adapted by cities and research teams using their own data</strong>. 
        For implementation guidance, please refer to the <strong><a href="https://city-syntax.github.io/buildings.sg/documentation.html" target="_blank" class="link">Documentation</a></strong> 
        or explore the <strong><a href="https://github.com/City-Syntax/buildings.city" target="_blank" class="link">Open-source Package</a></strong>.</p>
        
        <div class="doc-button-row">
            <a href="https://github.com/City-Syntax/buildings.city/blob/main/README.md" target="_blank" rel="noopener noreferrer" class="doc-button">Learn More</a>
            <a href="https://github.com/City-Syntax/buildings.city" target="_blank" rel="noopener noreferrer" class="doc-button">Download Package</a>
        </div>
        <br><br>

        <h2>Quick Start Guide</h2>
        <div style="text-align: center;">
            <a href="documentation.html" target="_blank" rel="noopener noreferrer" class="doc-button">View Documentation</a>
        </div>
        <br><br>
        ...
        Users should independently verify all information through official sources before taking any action based on this platform. The developers, contributors, and affiliated organizations expressly disclaim all liability for any consequences arising from the use of this tool.</p>
        <br>
...
downloadItems.forEach(item => {
    item.addEventListener("click", () => {
        ...
        const filePath = item.getAttribute("download-path") || ("download/" + fileName); // 支持子目录下载
