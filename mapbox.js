...
function addCustomSourcesAndLayers() {
    ...
    map.addSource('buildings_all', {
        type: 'vector',
        url: 'mapbox://citysyntax.8pkku6ha'
    });
...
function analyzePolygon(e) {
    ...
    features.forEach(function (feature) {
        ...
        if (isInside) {
            count++;
            totalEnergy += Number(feature.properties.energy_total) || 0;
            totalEmbodiedCarbon += Number(feature.properties.embodied_carbon) || 0;
            totalGrossFloorArea += Number(feature.properties['gross_floor_area']) || 0;
