...
<p align="left">
  <a href="http://buildings.sg/" style="padding:8px 14px; border:1px solid #d0d7de; border-radius:6px; text-decoration:none; font-size:14px;">
    🌐 Buildings.sg
  </a>

  <a href="https://city-syntax.github.io/buildings.sg/documentation.html" style="padding:8px 14px; border:1px solid #d0d7de; border-radius:6px; text-decoration:none; font-size:14px; margin-left:6px;">
    📘 Documentation
  </a>

  <a href="https://github.com/City-Syntax/buildings.sg/tree/main" style="padding:8px 14px; border:1px solid #d0d7de; border-radius:6px; text-decoration:none; font-size:14px; margin-left:6px;">
    🛠️ GitHub Repo
  </a>
</p>
